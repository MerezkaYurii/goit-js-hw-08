...
const sourse = currentImg.children[0].firstElementChild.dataset.sourse;
const alt = currentImg.children[0].firstElementChild.alt;

const instance = basicLightbox.create(`
<div class = "modal">
<img src = "${sourse}" alt = "${alt}"/>
</div>
`)
instance.show();
};
